...
def get_llm():
    ...
    try:
        ...
        llm = ChatOpenAI(
            model_name="amazon/nova-2-lite-v1:free",#"google/gemini-2.0-flash-exp:free",#"meta-llama/llama-3-8b-instruct", # "microsoft/Phi-3-mini-128k-instruct",#"meta-llama/llama-3-8b-instruct",
