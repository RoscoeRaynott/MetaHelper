...
def get_llm():
    ...
    try:
        ...
        llm = ChatOpenAI(
            model_name="meta-llama/llama-3.2-3b-instruct",#"meta-llama/llama-3-8b-instruct", #"amazon/nova-2-lite-v1",#""google/gemini-2.0-flash-exp",#"meta-llama/llama-3.3-70b-instruct",#google/gemini-2.0-flash-exp:free",# "microsoft/Phi-3-mini-128k-instruct",#"meta-llama/llama-3-8b-instruct",
